...
# 设置模型和输出路径
MODEL_PATH="./outputs"  # LoRA模型路径
BASE_MODEL="Qwen/Qwen2-VL-2B-Instruct"  # 基础模型
RESULTS_DIR="./results"
TIMESTAMP=$(date +%Y%m%d-%H%M%S)
OUTPUT_FILE="${RESULTS_DIR}/lora_evaluation_results_${TIMESTAMP}.json"
...
WANDB_NAME="qwen2-vl-2b-lora-eval-${TIMESTAMP}"
